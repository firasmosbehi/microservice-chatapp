...
class ChatService:
    ...
    def create_room(self, name: str, creator_id: int, description: Optional[str] = None, 
                   is_private: bool = False, invited_users: Optional[List[int]] = None) -> Dict:
    ...
    async def join_room(self, room_id: str, user_id: int, username: str) -> Dict:
        ...
        self.chat_rooms[room_id]["member_count"] = len(self.chat_rooms[room_id]["members"])
    ...
    async def send_message(self, room_id: str, user_id: int, username: str, 
